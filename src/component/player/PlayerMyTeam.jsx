...
const PlayerMyTeam = () => {
  ...
  useEffect(() => {
    dispatch(getAuthenticatedPlayer());
  }, [dispatch]);
            ...
            >
              <div className={dashboard["secondary--container"]}>
                <div className={dashboard["card--details__wrapper"]}>
                  ...
                  <p className={style["form-header"]}>My Team</p>
                  ...
                  {!team?.name ? (
                    ...
                    <>
                      ...
                      <div className={dashboard["card--details"]}>
                        <span>Age Group:</span> {team.ageGroup || "—"}
                      </div>
                      <div className={dashboard["card--details"]}>
                        <span>Division:</span> {team.division || "—"}
                      </div>
                      <div className={dashboard["card--details"]}>
                        <span>Coach:</span> {team.coachName || player?.coachName || "—"}
                      </div>
                    </>
                  )}
                </div>
