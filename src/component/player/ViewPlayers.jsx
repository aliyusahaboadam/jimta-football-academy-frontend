...
import { deletePlayerById, getAllPlayers } from "../../redux/reducer/playerSlice";
import Loading from "../Chunks/loading";
import dashboard from "../style/Dashboard.module.css";
import PlayerActionMenu from "../utility/PlayerActionMenu";
...
const ViewPlayers = () => {
  ...
  const handleEdit = (id) => navigate(`/admin/players/update/${id}`);
  const handleViewDetails = (id) => navigate(`/admin/players/details/${id}`);
          ...
          <Box sx={{ display: "flex" }}>
            ...
            >
              <div className={dashboard["secondary--container"]}>
                <div
                  className={[dashboard["card--add"], dashboard["card--primary"]].join(
                    " "
                  )}
                >
                      ...
                      {rows.length === 0 && (
                        <StyledTableRow>
                          <StyledTableCell colSpan={6} align="center">
                            No players yet. Click "Add New Player" to create one.
                          </StyledTableCell>
                        </StyledTableRow>
                      )}
