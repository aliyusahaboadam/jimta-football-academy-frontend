...
const SeasonTotals = () => {
  ...
  const { seasonTotals, fetchingStatus } = perfState;
  ...
  useEffect(() => {
    if (selectedPlayerId) {
      dispatch(getSeasonTotals(selectedPlayerId));
    }
          ...
          <div className={dashboard["secondary--container"]}>
            ...
            <div className={[dashboard["card--add"], dashboard["card--primary"]].join(" ")}>
              <div className={dashboard["card_body"]}>
                <div className={dashboard["card--small-head"]}>Season Totals</div>

                <FormControl fullWidth margin="normal">
                  <InputLabel sx={{ fontSize: 16 }}>Select Player</InputLabel>
                  <Select
                    label="Select Player"
