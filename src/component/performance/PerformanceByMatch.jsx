...
const statusClass = (status) => {
  switch (status) {
    ...
    case "IN_PROGRESS": return "badge--secondary";
    case "CANCELLED":   return "badge--primary";
...
const PerformanceByMatch = () => {
  ...
  const goToSide = (matchId, side) => {
    navigate(`/admin/performance/match/${matchId}?side=${side}`);
  };
              ...
              {matchList.length === 0 ? (
                <div className={dashboard["secondary--container"]}>
                  <div className={dashboard["empty"]}>
                    <h4 className={dashboard["empty__title"]}>No matches yet</h4>
                    <p className={dashboard["empty__text"]}>
                      Schedule a match first, then come back to record performances.
                    </p>
                  </div>
                </div>
              ) : (
                    ...
                    {matchList.map((match, index) => {
                      ...
                      return (
                        <div
                          key={match.id}
                          className={[
                            dashboard["match__card"],
                            dashboard[index % 2 === 0 ? "match__card--primary" : "match__card--secondary"],
                          ].join(" ")}
                        >
                          <div className={dashboard["match__body"]}>
                            <div className={dashboard["match__top"]}>
                              ...
                              <span
                                className={[
                                  dashboard["badge"],
                                  dashboard[statusClass(match.status)],
                                ].join(" ")}
                              >
                            ...
                            <h3 className={dashboard["match__title"]}>
                              {homeName(match)} <span className={dashboard["match__vs"]}>vs</span> {awayName(match)}
                            </h3>
                          ...
                          <div className={dashboard["match__footer"]}>
                            <button
                              onClick={() => goToSide(match.id, "home")}
                              className={[dashboard["btn"], dashboard["btn--primary"]].join(" ")}
                            >
                              Home Players
                            </button>
                            <button
                              onClick={() => goToSide(match.id, "away")}
                              className={[dashboard["btn"], dashboard["btn--secondary"]].join(" ")}
                            >
                              Away Players
                            </button>
                          </div>
...
export default PerformanceByMatch;