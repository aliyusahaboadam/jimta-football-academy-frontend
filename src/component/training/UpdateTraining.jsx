...
import { getTrainingById, updateTraining } from "../../redux/reducer/trainingSlice";
...
const UpdateTraining = () => {
  ...
  const handleFormSubmit = async (values, { resetForm }) => {
    ...
    try {
      const result = await dispatch(updateTraining({ id: Number(id), trainingData: payload })).unwrap();
                ...
                <div className={style.form}>
                  ...
                  <div className={style["form-link--container"]}>
                    <span className={style["form-link"]}>
                      <a className={style["link__register"]} href="/admin/trainings">← Back to Trainings</a>
                    </span>
                  </div>
                </div>
              )}
