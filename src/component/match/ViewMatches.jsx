          ...
          <Box sx={{ display: "flex" }}>
            ...
            >
              ...
              <div style={{cursor: 'pointer'}} onClick={() => toggleChevron('chevron-1')} className={[navbar['collapsible'], navbar[activeChevron === 'chevron-1' ? 'collapsible--expanded' : null]].join(' ')}>
                <header className={navbar['collapsible__header']}>
                  <div className={navbar['collapsible__icon']}>
                    ...
                    <p className={navbar['collapsible__heading']}>Players</p>
                  </div>
                ...
                <div className={navbar['collapsible__content--drawer']}>
                  <a href="/admin/players/add" className={navbar['link--drawer']} onClick={(e) => e.stopPropagation()}>Add Player</a>
                  <a href="/admin/players" className={navbar['link--drawer']} onClick={(e) => e.stopPropagation()}>View Players</a>
                  <a href="/admin/players/gallery" className={navbar['link--drawer']} onClick={(e) => e.stopPropagation()}>Gallery</a>
                </div>
              </div>
              ...
              <div style={{cursor: 'pointer'}} onClick={() => toggleChevron('chevron-2')} className={[navbar['collapsible'], navbar[activeChevron === 'chevron-2' ? 'collapsible--expanded' : null]].join(' ')}>
                <header className={navbar['collapsible__header']}>
                  <div className={navbar['collapsible__icon']}>
                    ...
                    <p className={navbar['collapsible__heading']}>Coaches</p>
                  </div>
                ...
                <div className={navbar['collapsible__content--drawer']}>
                  <a href="/admin/coaches/add" className={navbar['link--drawer']} onClick={(e) => e.stopPropagation()}>Add Coach</a>
                  <a href="/admin/coaches" className={navbar['link--drawer']} onClick={(e) => e.stopPropagation()}>View Coaches</a>
                </div>
              </div>
              ...
              <div style={{cursor: 'pointer'}} onClick={() => toggleChevron('chevron-3')} className={[navbar['collapsible'], navbar[activeChevron === 'chevron-3' ? 'collapsible--expanded' : null]].join(' ')}>
                <header className={navbar['collapsible__header']}>
                  <div className={navbar['collapsible__icon']}>
                    ...
                    <p className={navbar['collapsible__heading']}>Teams</p>
                  </div>
                ...
                <div className={navbar['collapsible__content--drawer']}>
                  <a href="/admin/teams/add" className={navbar['link--drawer']} onClick={(e) => e.stopPropagation()}>Add Team</a>
                  <a href="/admin/teams" className={navbar['link--drawer']} onClick={(e) => e.stopPropagation()}>View Teams</a>
                  <a href="/admin/teams/by-age-group" className={navbar['link--drawer']} onClick={(e) => e.stopPropagation()}>Teams By Age Group</a>
                </div>
              </div>
              ...
              <div style={{cursor: 'pointer'}} onClick={() => toggleChevron('chevron-4')} className={[navbar['collapsible'], navbar[activeChevron === 'chevron-4' ? 'collapsible--expanded' : null]].join(' ')}>
                <header className={navbar['collapsible__header']}>
                  <div className={navbar['collapsible__icon']}>
                    ...
                    <p className={navbar['collapsible__heading']}>Matches</p>
                  </div>
                ...
                <div className={navbar['collapsible__content--drawer']}>
                  <a href="/admin/matches/add" className={navbar['link--drawer']} onClick={(e) => e.stopPropagation()}>Schedule Match</a>
                  <a href="/admin/matches" className={navbar['link--drawer']} onClick={(e) => e.stopPropagation()}>View Matches</a>
                  <a href="/admin/matches/by-status" className={navbar['link--drawer']} onClick={(e) => e.stopPropagation()}>Matches By Status</a>
                </div>
              </div>
              ...
              <div style={{cursor: 'pointer'}} onClick={() => toggleChevron('chevron-5')} className={[navbar['collapsible'], navbar[activeChevron === 'chevron-5' ? 'collapsible--expanded' : null]].join(' ')}>
                <header className={navbar['collapsible__header']}>
                  <div className={navbar['collapsible__icon']}>
                    ...
                    <p className={navbar['collapsible__heading']}>Performance</p>
                  </div>
                ...
                <div className={navbar['collapsible__content--drawer']}>
                  <a href="/admin/performance/add" className={navbar['link--drawer']} onClick={(e) => e.stopPropagation()}>Record Performance</a>
                  <a href="/admin/performance/by-match" className={navbar['link--drawer']} onClick={(e) => e.stopPropagation()}>By Match</a>
                  <a href="/admin/performance/season-totals" className={navbar['link--drawer']} onClick={(e) => e.stopPropagation()}>Season Totals</a>
                </div>
              </div>
              ...
              <div style={{cursor: 'pointer'}} onClick={() => toggleChevron('chevron-6')} className={[navbar['collapsible'], navbar[activeChevron === 'chevron-6' ? 'collapsible--expanded' : null]].join(' ')}>
                <header className={navbar['collapsible__header']}>
                  <div className={navbar['collapsible__icon']}>
                    ...
                    <p className={navbar['collapsible__heading']}>Admins</p>
                  </div>
                ...
                <div className={navbar['collapsible__content--drawer']}>
                  <a href="/admin/admins/add" className={navbar['link--drawer']} onClick={(e) => e.stopPropagation()}>Add Admin</a>
                  <a href="/admin/admins" className={navbar['link--drawer']} onClick={(e) => e.stopPropagation()}>View Admins</a>
                </div>
              </div>
              ...
              <div style={{cursor: 'pointer'}} onClick={() => toggleChevron('chevron-7')} className={[navbar['collapsible'], navbar[activeChevron === 'chevron-7' ? 'collapsible--expanded' : null]].join(' ')}>
                ...
                <div className={navbar['collapsible__content--drawer']}>
                  <a href="/admin/profile" className={navbar['link--drawer']} onClick={(e) => e.stopPropagation()}>My Profile</a>
                  <a href="/admin/change-password" className={navbar['link--drawer']} onClick={(e) => e.stopPropagation()}>Change Password</a>
                </div>
              </div>
              ...
              <div className={dashboard["secondary--container"]}>
                <div className={[dashboard["card--add"], dashboard["card--primary"]].join(" ")}>
                  <div className={dashboard["card_body"]}>
                    <div className={dashboard["card--small-head"]}>All Matches</div>
                    <button
                ...
                <TableContainer component={Paper} sx={{ marginTop: 2 }}>
                  <Table sx={{ minWidth: 750 }} aria-label="matches table">
                    <TableHead>
                      <TableRow>
                      ...
                      {rows.length === 0 && (
                        <StyledTableRow>
                          <StyledTableCell colSpan={7} align="center">
                            No matches yet. Click "Schedule New Match" to create one.
                          </StyledTableCell>
                        </StyledTableRow>
                      )}
