...
import { getTeamById } from "../../redux/reducer/teamSlice";
        ...
        >
          <div className={dashboard["secondary--container"]}>
            <div className={dashboard["card--details__wrapper"]}>
              ...
              <p className={style["form-header"]}>{data?.name || "Team Details"}</p>

              <div className={dashboard["card--details"]}>
                <span>Name:</span> {data?.name || "—"}
              </div>
              <div className={dashboard["card--details"]}>
                <span>Age Group:</span> {data?.ageGroup || "—"}
              </div>
              <div className={dashboard["card--details"]}>
              ...
              <div style={{ display: "flex", gap: "1rem", marginTop: "2rem" }}>
                <button
                  onClick={() => navigate(`/admin/teams/update/${id}`)}
