...
const TrainingActionMenu = ({ row, onDelete, onEdit, onView, mode = "admin" }) => {
  ...
  return (
    <>
      ...
      <Menu
        ...
        slotProps={{ paper: { style: { borderRadius: "8px", boxShadow: "0 0 20px 10px #f3f3f3" } } }}
      >
      ...
      >
        <div style={{ width: "100%", background: "#fff" }} className={dashboard["card--alert-error"]}>
          <div className={dashboard["card_body"]}>
            ...
            <Typography sx={{ fontSize: 20, color: "#9a99ac", marginTop: "1rem" }}>
        ...
        <DialogActions style={{ padding: "1.5rem 3rem", display: "flex", flexDirection: "row", justifyContent: "space-between" }}>
          <Button style={{ fontSize: 15 }} onClick={handleCancelDelete}
            sx={{ borderRadius: "15px", color: "#fff", backgroundColor: "#388E3C", "&:hover": { backgroundColor: "#2f7533" } }}>
            Cancel
          </Button>
          <Button style={{ fontSize: 15 }} onClick={handleConfirmDelete}
            sx={{ borderRadius: "15px", color: "#fff", backgroundColor: "#F44336", "&:hover": { backgroundColor: "#bd3228" } }}
            autoFocus>
            Delete
          </Button>
        </DialogActions>
...
export default TrainingActionMenu;