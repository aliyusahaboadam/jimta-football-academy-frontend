...
const PerformanceActionMenu = ({ row, onDelete, onView }) => {
          ...
          <div className={dashboard["card_body"]}>
            ...
            <Typography sx={{ fontSize: 20, color: "#9a99ac", marginTop: "1rem" }}>
              <p className={dashboard["alert-message"]}>
                Are you sure you want to delete the performance record for {playerName}?
              </p>
            </Typography>
          </div>
        </div>
...
export default PerformanceActionMenu;