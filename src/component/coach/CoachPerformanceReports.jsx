              ...
              <div className={dashboard["secondary--container"]}>
                <div className={[dashboard["card--add"], dashboard["card--primary"]].join(" ")}>
                  <div className={dashboard["card_body"]}>
                    <div className={dashboard["card--small-head"]}>Performance Reports</div>
                    <p style={{ fontSize: 14, margin: 0, color: "#9a99ac" }}>
                      Select a match to view its recorded performances.
                    </p>
                  </div>
                </div>

                <TableContainer component={Paper} sx={{ marginTop: 2 }}>
                  <Table sx={{ minWidth: 650 }} aria-label="performance reports table">
                    <TableHead>
                      <TableRow>
                        ...
                        matchList.map((row, index) => (
                          <StyledTableRow key={row.id}>
                            ...
                            <StyledTableCell align="right">
                              <button
                                onClick={() =>
                                  navigate(`/coach/performance/match/${row.id}?side=home`)
                                }
                                className={[dashboard["btn"], dashboard["btn--primary"]].join(" ")}
                                style={{ fontSize: 13, padding: "0.6rem 1rem", margin: 0 }}
                              >
                                View
                              </button>
                            </StyledTableCell>
...
export default CoachPerformanceReports;