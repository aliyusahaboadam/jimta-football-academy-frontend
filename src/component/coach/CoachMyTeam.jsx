              ...
              <div className={dashboard["secondary--container"]}>
                {teamList.length === 0 ? (
                  <div className={dashboard["empty"]}>
                    <h4 className={dashboard["empty__title"]}>No team assigned</h4>
                    <p className={dashboard["empty__text"]}>
                      Ask an admin to assign you a team.
                    </p>
                  </div>
                ) : (
                  <div className={[dashboard["grid"], dashboard["grid--1x2"]].join(" ")}>
                    {teamList.map((team) => (
                      <div
                        key={team.id}
                        className={[dashboard["team__card"], dashboard["team__card--primary"]].join(" ")}
                      >
                        <div className={dashboard["team__body"]}>
                          <h3 className={dashboard["team__name"]}>{team.name}</h3>
                          <p className={dashboard["team__division"]}>{team.division || "—"}</p>
