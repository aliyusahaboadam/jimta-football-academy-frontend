        ...
        >
          ...
          <List>
            ...
            >
              ...
              <div className={dashboard["collapsible__content--drawer"]}>
                <a href="/coach/team" className={dashboard["link--drawer"]} onClick={(e) => e.stopPropagation()}>Team Overview</a>
                <a href="/coach/players" className={dashboard["link--drawer"]} onClick={(e) => e.stopPropagation()}>My Players</a>
              </div>
            </div>
            ...
            >
              ...
              <div className={dashboard["collapsible__content--drawer"]}>
                <a href="/coach/activities" className={dashboard["link--drawer"]} onClick={(e) => e.stopPropagation()}>View Activities</a>
                <a href="/coach/activities/videos" className={dashboard["link--drawer"]} onClick={(e) => e.stopPropagation()}>Videos</a>
                <a href="/coach/activities/images" className={dashboard["link--drawer"]} onClick={(e) => e.stopPropagation()}>Images</a>
              </div>
            </div>
            ...
            >
              ...
              <div className={dashboard["collapsible__content--drawer"]}>
                <a href="/coach/matches" className={dashboard["link--drawer"]} onClick={(e) => e.stopPropagation()}>Upcoming Matches</a>
                <a href="/coach/matches/results" className={dashboard["link--drawer"]} onClick={(e) => e.stopPropagation()}>Match Results</a>
              </div>
            </div>
            ...
            >
              ...
              <div className={dashboard["collapsible__content--drawer"]}>
                <a href="/coach/performance/add" className={dashboard["link--drawer"]} onClick={(e) => e.stopPropagation()}>Record Performance</a>
                <a href="/coach/performance" className={dashboard["link--drawer"]} onClick={(e) => e.stopPropagation()}>Performance Reports</a>
              </div>
            </div>
            ...
            >
              ...
              <div className={dashboard["collapsible__content--drawer"]}>
                <a href="/coach/profile" className={dashboard["link--drawer"]} onClick={(e) => e.stopPropagation()}>My Profile</a>
                <a href="/coach/change-password" className={dashboard["link--drawer"]} onClick={(e) => e.stopPropagation()}>Change Password</a>
              </div>
            </div>
          </List>
        </Drawer>
          ...
          <div className={dashboard["secondary--container"]}>
            <div className={dashboard["card--details__wrapper"]}>
              ...
              <div style={{ display: "flex", gap: "1rem", marginTop: "2rem" }}>
                <button
                  onClick={() => navigate(`/coach/trainings/update/${id}`)}
                  className={[style["btn"], style["btn--block"], style["btn--primary"]].join(" ")}
                >
                  Edit
                </button>
                <button
                  onClick={() => navigate("/coach/trainings")}
...
export default CoachTrainingDetails;