...
import { saveCoach } from "../../redux/reducer/coachSlice";
...
const AddCoach = () => {
  ...
  const handleFormSubmit = async (values, { resetForm }) => {
    ...
    try {
      const result = await dispatch(saveCoach(payload)).unwrap();
      setAlertType("success");
      setMessage(result.message || "Coach added successfully");
    } catch (error) {
      setAlertType("error");
            ...
            >
              {({
                ...
                <div className={style.form}>
                  ...
                  <p className={style["form-header"]}>Register Coach</p>
