...
import { sendPasswordResetCoach } from "../../redux/reducer/passwordSlice";
  ...
  const handleFormSubmit = async (values, { resetForm }) => {
    try {
      const body = await dispatch(
        sendPasswordResetCoach({ password: values.password })
      ).unwrap();
          ...
          <Card>
            ...
            <div className={style["form-link--container"]}>
              <span className={style["form-link"]}>
                <a className={style["link__register"]} href="/coach/profile">
                  ← Back to Profile
                </a>
              </span>
            </div>
